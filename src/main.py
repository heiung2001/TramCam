...
if __name__ == "__main__":
    ...
    parser.add_argument('-use_fp16', default=False, type=bool, choices=[True, False], action=argparse.BooleanOptionalAction, help="Whether to use fp16 or not")
    ...
    # lora
    parser.add_argument('-use_lora', default=False, type=bool, action=argparse.BooleanOptionalAction, help='Whether to use lora or not')
    ...
    # debug
    parser.add_argument('-debug', default=False, type=bool, action=argparse.BooleanOptionalAction, help='Enable debug mode')
